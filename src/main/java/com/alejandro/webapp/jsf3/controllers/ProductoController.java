package com.alejandro.webapp.jsf3.controllers;

import com.alejandro.webapp.jsf3.MyFacesContext;
...
//    }
    ...
    public void guardar() {
        ...
        listado = service.listar(); // Para que cargue el listado con ajax una vez hagas el update
        producto = new Producto();
    }
    ...
    public void eliminar(Producto producto) {
        ...
        listado = service.listar(); // Para que cargue el listado con ajax una vez hagas el delete
    }
